...
export class Mhc extends Component {
  state = {
    lang: 0
  };
  render() {
    const lang = {
      header: [
        "Тема: «Изотопный лептон: гипотеза и теории»",
        "Topic: «Изотопный лептон: гипотеза и теории»"
      ],
      text: [
